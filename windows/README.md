...
Release v1.5.95 keeps the permanent helper in the current user's unversioned
...
1. Download **ChatGPT-Remote-Enabler-Windows-x64-v1.5.95.zip** from [v1.5.95 downloads](https://github.com/Belgian-Coder/ChatGPT-Remote-Enabler/releases/tag/v1.5.95). Read the verification limitations.
...
v1.5.95 is a normal release and is discoverable by the existing automatic updater. The first Windows upgrade from v1.5.31 attaches the new update helper even through the legacy launcher.
