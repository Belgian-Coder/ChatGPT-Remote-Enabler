...
v1.5.100 loads verified Remote Enabler releases into the current renderer without
...
Events, survives renderer replacement during startup, and prefers a standalone
Git installation over the Xcode command-line-tools shim. Automatic restarts use exact renderer quit dispatch or
one exact-PID graceful signal fallback with fail-closed identity checks; the
Windows progress and `native-renderer-quit`/`WM_CLOSE` behavior remains intact.
...
- **[Download Windows 11 x64](https://github.com/Belgian-Coder/ChatGPT-Remote-Enabler/releases/download/v1.5.100/ChatGPT-Remote-Enabler-Windows-x64-v1.5.100.zip)** and follow the [Windows installation guide](windows/README.md).
- **[Download macOS Apple Silicon](https://github.com/Belgian-Coder/ChatGPT-Remote-Enabler/releases/download/v1.5.100/ChatGPT-Remote-Enabler-macOS-arm64-v1.5.100.zip)** and follow the [macOS installation guide](macos/README.md).
- Use the [v1.5.100 release page](https://github.com/Belgian-Coder/ChatGPT-Remote-Enabler/releases/tag/v1.5.100) to inspect release notes and published checksums.
...
macOS keeps one permanent unversioned installation root at
`~/Library/Application Support/CodexRemoteFeatures/ChatGPT-Remote-Enabler-macOS-arm64`.
Existing version-named package roots are migrated during a successful update.
The LaunchAgent and Applications shortcut are rebuilt against the stable root
before the old roots are removed.
