...
Release v1.5.55 keeps device inventory and shared aliases fresh while the app is backgrounded, reports stale local publication honestly, and retains the v1.5.54 search and navigation improvements. Installation and live multi-device acceptance remain separate checks.
...
1. Download **ChatGPT-Remote-Enabler-Windows-x64-v1.5.55.zip** from [v1.5.55 downloads](https://github.com/Belgian-Coder/ChatGPT-Remote-Enabler/releases/tag/v1.5.55). Read the verification limitations.
...
v1.5.55 is a normal release and is discoverable by the existing automatic updater. The first Windows upgrade from v1.5.31 attaches the new update helper even through the legacy launcher.
