...
1. Download **ChatGPT-Remote-Enabler-Windows-x64-v1.5.53.zip** from [v1.5.53 downloads](https://github.com/Belgian-Coder/ChatGPT-Remote-Enabler/releases/tag/v1.5.53). Read the verification limitations.
...
v1.5.53 is a normal release and is discoverable by the existing automatic updater. The first Windows upgrade from v1.5.31 attaches the new update helper even through the legacy launcher.
