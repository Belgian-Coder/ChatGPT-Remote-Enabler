...
**Testing status:** real v1.5.42 installation and installed-launcher restart passed on macOS. Startup testing exposed lost executable modes, corrected in v1.5.43. A fresh login trigger and Settings-queued update remain separate acceptance checks. v1.5.43 is a normal release.

## 1. Download and extract

1. Download **ChatGPT-Remote-Enabler-macOS-arm64-v1.5.43.zip** from [v1.5.43 downloads](https://github.com/Belgian-Coder/ChatGPT-Remote-Enabler/releases/tag/v1.5.43).
...
The v1.5.43 release shares the Windows renderer and automated fixtures.
