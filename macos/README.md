...
Release v1.5.72 moves recognized version-named installations to the fixed
...
v1.5.72 is a normal release. Publication is not installation. An older update
coordinator uses its existing graceful quit for this first upgrade; once
v1.5.72 is loaded, later compatible releases can update in place.

## 1. Download and extract

1. Download **ChatGPT-Remote-Enabler-macOS-arm64-v1.5.72.zip** from [v1.5.72 downloads](https://github.com/Belgian-Coder/ChatGPT-Remote-Enabler/releases/tag/v1.5.72).
