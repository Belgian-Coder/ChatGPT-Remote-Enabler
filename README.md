...
v1.5.73 loads compatible verified releases into the current renderer without
...
- **[Download Windows 11 x64](https://github.com/Belgian-Coder/ChatGPT-Remote-Enabler/releases/download/v1.5.73/ChatGPT-Remote-Enabler-Windows-x64-v1.5.73.zip)** and follow the [Windows installation guide](windows/README.md).
- **[Download macOS Apple Silicon](https://github.com/Belgian-Coder/ChatGPT-Remote-Enabler/releases/download/v1.5.73/ChatGPT-Remote-Enabler-macOS-arm64-v1.5.73.zip)** and follow the [macOS installation guide](macos/README.md).
- Use the [v1.5.73 release page](https://github.com/Belgian-Coder/ChatGPT-Remote-Enabler/releases/tag/v1.5.73) to inspect release notes and published checksums.
