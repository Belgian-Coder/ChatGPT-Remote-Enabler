...
Release v1.5.87 moves recognized version-named installations to the fixed
...
v1.5.87 is a normal release. Publication is not installation. An older update
...
1. Download **ChatGPT-Remote-Enabler-macOS-arm64-v1.5.87.zip** from [v1.5.87 downloads](https://github.com/Belgian-Coder/ChatGPT-Remote-Enabler/releases/tag/v1.5.87).
