...
Release v1.5.56 keeps device inventory and shared aliases fresh even when hidden-renderer timers freeze, reports stale local publication honestly, and retains the v1.5.54 search and navigation improvements. Installation and live multi-device acceptance remain separate checks.
...
1. Download **ChatGPT-Remote-Enabler-Windows-x64-v1.5.56.zip** from [v1.5.56 downloads](https://github.com/Belgian-Coder/ChatGPT-Remote-Enabler/releases/tag/v1.5.56). Read the verification limitations.
...
v1.5.56 is a normal release and is discoverable by the existing automatic updater. The first Windows upgrade from v1.5.31 attaches the new update helper even through the legacy launcher.
