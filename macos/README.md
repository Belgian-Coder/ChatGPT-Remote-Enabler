...
Release v1.5.97 moves recognized version-named installations to the fixed
...
v1.5.97 is a normal release. Publication is not installation. An older update
...
1. Download **ChatGPT-Remote-Enabler-macOS-arm64-v1.5.97.zip** from [v1.5.97 downloads](https://github.com/Belgian-Coder/ChatGPT-Remote-Enabler/releases/tag/v1.5.97).
